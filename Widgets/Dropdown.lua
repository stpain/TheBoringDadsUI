...
TheBoringdadsDropDownTemplateMixin = {}

function TheBoringdadsDropDownTemplateMixin:OnLoad()
    self.isOpen = false;
...
function TheBoringdadsDropDownTemplateMixin:SetWidth(width)
    --self.flyout:SetWidth(width)
end

function TheBoringdadsDropDownTemplateMixin:SetText(text)
    self.label.text:SetText(text)
end

function TheBoringdadsDropDownTemplateMixin:ClearMenu()
    self.flyout.listview.DataProvider:Flush()
end

function TheBoringdadsDropDownTemplateMixin:SetMenu(t)
...
TheBoringdadsDropDownListviewItemTemplateMixin = {}

function TheBoringdadsDropDownListviewItemTemplateMixin:OnLoad()
    self.dropdown = self:GetParent():GetParent():GetParent():GetParent():GetParent()
end

function TheBoringdadsDropDownListviewItemTemplateMixin:SetDataBinding(binding, height)
...
function TheBoringdadsDropDownListviewItemTemplateMixin:ResetDataBinding()
