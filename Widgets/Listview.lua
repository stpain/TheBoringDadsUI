TheBoringdadsListviewMixin = {}

function TheBoringdadsListviewMixin:OnLoad()
...
function TheBoringdadsListviewMixin:OnElementInitialize(element, elementData, isNew)
    if isNew then
        element:OnLoad();
    end
    local height = self.elementHeight;
...
function TheBoringdadsListviewMixin:OnElementReset(element)
